...
require_once("../models/forgetpassword.s.php");
require_once("../controllers/forgetpassword.s.php");

require_once("../public/assets/libs/PHPMailer-master/PHPMailer-master/src/PHPMailer.php");
require_once("../public/assets/libs/PHPMailer-master/PHPMailer-master/src/SMTP.php");
require_once("../public/assets/libs/PHPMailer-master/PHPMailer-master/src/Exception.php");
...
function sendMail($subject, $msg, $emailAddr, $username, $password, $host)
{
    try {
        ...
        $mail->setFrom('dieuthaole06@gmail.com');
    ...
    if (!empty($user_email)) {
        ...
        if (!empty($user)) {
            ...
            try {
                ...
                sendMail('Reset password', 'Your code is: ' . $pass_code, $user_email, 'dieuthaole06@gmail.com', 'bpha kdit zjia pnpx', 'smtp.gmail.com');
