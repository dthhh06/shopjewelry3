...
<head>
      ...
      <!-- Js -->
      <script src="../public/js/payment.js" type="module" defer></script>
                        ...
                        <div class="col-lg-4 col-md-4 border-start pe-5" style="background-color: #fafafa;">
                              ...
                              <div class="ps-4">
                                    ...
                                    <div class="row pb-3 border-bottom mb-3">
                                          ...
                                          <button type="button" name="apply-discount-btn" class="btn btn-primary p-2 mb-0 ms-auto" style="width: 30%; background-color: #d4af37; border: none;">Apply</button>
                                    </div>
                                    <div class="row pb-3 border-bottom mb-3">
                                    ...
                                    <div class="row pb-3 mb-3">
                                          <div class="back_to_cart d-flex justify-content-between align-items-center">
                                                ...
                                                <button type="button" name="place-order" value="place-order" class="btn btn-primary" style="background-color: #d4af37; border: none; padding: 12px 16px;">PLACE ORDER</button>
                                          </div>
                                    </div>
                              </div>
                        </div>
